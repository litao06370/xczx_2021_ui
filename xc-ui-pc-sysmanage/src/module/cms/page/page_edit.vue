...
<script>
  ...
  export default {
    ...
    created: function() {
      /* index.js中定义的 http....abc/ab/:pageId (使用的restful风格),此时路由取值方式 $route.params
          若按照传统方式 http.....abc/ab?pageId=value 的方式,此时路由取值方式 $route.query
      */
    ...
    mounted: function() {
      ...
      this.templateList = [{
        ...
        {
          templateId: '6013785f082dc01b041dd429',
          templateName: '轮播图'
        }
      ]
    }
